...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	8a 80 24 0b 00 00    	mov    0xb24(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 5a8:	75 07                	jne    5b1 <printf+0x10f>
          s = "(null)";
 5aa:	c7 45 f4 b0 08 00 00 	movl   $0x8b0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 66a:	a1 40 0b 00 00       	mov    0xb40,%eax
...
free(void *ap)
{
 ...
 735:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 73a:	c9                   	leave  
 73b:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 792:	83 c4 10             	add    $0x10,%esp
  return freep;
 795:	a1 40 0b 00 00       	mov    0xb40,%eax
}
 79a:	c9                   	leave  
 79b:	c3                   	ret    
